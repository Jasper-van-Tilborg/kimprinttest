...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      {step === 3 ? (
        <div className="py-16 min-h-[70vh] flex items-center">
          <div className="grid-12 w-full">
            <div className="col-10 col-start-2">
              <div className="bg-white rounded-lg p-12 text-center shadow-2xl max-w-2xl mx-auto">
                <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-[scale_0.5s_ease-in-out]">
                ...
                <p className="text-gray-600 mb-8">
                  Je ontvangt een bevestigingsmail op <span className="font-medium text-black">{formData.email}</span>
                </p>
                
                <div className="bg-gray-50 rounded-xl p-8 mb-10 border-2 border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/"
                    className="bg-black text-white px-10 py-4 rounded-lg hover:bg-gray-800 transition-all hover:shadow-lg font-medium text-lg"
                  >
                    Terug naar Home
                  </Link>
                  <Link
                    href="/assortiment"
                    className="bg-white border-2 border-black text-black px-10 py-4 rounded-lg hover:bg-gray-50 transition-all hover:shadow-lg font-medium text-lg"
                  >
                    Verder Winkelen
                  </Link>
                </div>
              ...
              <div className="col-12">
                <div className="flex items-center justify-center gap-4">
                  <div className={`flex items-center gap-2 ${step >= 1 ? 'text-[#8B4513]' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step >= 1 ? 'bg-[#8B4513] text-white' : 'bg-gray-200'}`}>
                      1
                    </div>
                    <span className="font-medium">Gegevens</span>
                  </div>
                  <div className="w-12 h-px bg-gray-300"></div>
                  <div className={`flex items-center gap-2 ${step >= 2 ? 'text-[#8B4513]' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${step >= 2 ? 'bg-[#8B4513] text-white' : 'bg-gray-200'}`}>
                      2
                    </div>
