...
export default function TassenPage() {
  ...
  // Bepaal beschikbare kleuren op basis van alle producten
            ...
            <div className="grid-12 h-full">
              <div className="col-12 flex flex-col justify-center items-center text-center px-4">
                ...
                <p className="text-white text-sm md:text-xl font-light drop-shadow-md">
                  Draagbare kunstwerken met jouw persoonlijke touch
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid-12">
          <div className="col-12">
            <div className="flex items-center text-xs md:text-sm text-gray-600">
              ...
              <span className="mx-1 md:mx-2">›</span>
              <span className="text-black font-medium">Totebags</span>
            </div>
          </div>
        </div>
      </div>
